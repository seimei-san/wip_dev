...
use App\Http\Controllers\WipMessageController;
use App\Http\Controllers\WipTaskSystemController;
use App\Http\Controllers\WipReportIntervalController;
use App\Http\Controllers\WipTaskSystemIntegrationController;
...
// WIP_TASK_SYSTEM::Routings
Route::get('/task_systems', [WipTaskSystemController::class, 'index'])->name('task_system_index');
Route::post('/task_system', [WipTaskSystemController::class, 'store'])->name('task_system_store');
Route::post('/task_systemedit/{task_sys}', [WipTaskSystemController::class, 'edit'])->name('task_sytem_edit');
Route::get('/task_systemedit/{task_sys}', [WipTaskSystemController::class, 'edit'])->name('edit');
Route::post('/task_system/update', [WipTaskSystemController::class, 'update'])->name('task_system_update');
Route::delete('/task_system/{task_sys}', [WipTaskSystemController::class, 'destroy'])->name('task_system_destroy');

// WIP_TASK_SYSTEM_INTEGRATION::Routings
Route::get('/task_system_integrations', [WipTaskSystemIntegrationController::class, 'index'])->name('task_system_integration_index');
Route::post('/task_system_integration', [WipTaskSystemIntegrationController::class, 'store'])->name('task_system_integration_store');
Route::post('/task_system_integrationedit/{task_sys_integ}', [WipTaskSystemIntegrationController::class, 'edit'])->name('task_sytem_integration_edit');
Route::get('/task_system_integrationedit/{task_sys_integ}', [WipTaskSystemIntegrationController::class, 'edit'])->name('edit');
Route::post('/task_system_integration/update', [WipTaskSystemIntegrationController::class, 'update'])->name('task_system_integration_update');
Route::delete('/task_system_integration/{task_sys_integ}', [WipTaskSystemIntegrationController::class, 'destroy'])->name('task_system_integration_destroy');

// WIP_REPORT_INTERVAL::Routings
Route::get('/report_intervals', [WipReportIntervalController::class, 'index'])->name('report_interval_index');
Route::post('/report_interval', [WipReportIntervalController::class, 'store'])->name('report_interval_store');
Route::post('/report_intervaledit/{report_interval}', [WipReportIntervalController::class, 'edit'])->name('report_interval_edit');
Route::get('/report_intervaledit/{report_interval}', [WipReportIntervalController::class, 'edit'])->name('edit');
Route::post('/report_interval/update', [WipReportIntervalController::class, 'update'])->name('report_interval_update');
Route::delete('/report_interval/{report_interval}', [WipReportIntervalController::class, 'destroy'])->name('report_interval_destroy');
...
// Route::resource('wip_msgs', 'WipMessageController');
Route::post('/show/{doc_id}', [WipMessageController::class, 'show'])->name('message_show');
Route::get('/msgs', [WipMessageController::class, 'index'])->name('message_index');
Route::post('/advice/{doc_id}', [WipMessageController::class, 'advice'])->name('score_advice');
