<x-app-layout>
    ...
    <div class="flex bg-gray-100">
        ...
        <div class="text-indigo-800 text-left px-4 py-4 mg-2">
            ...
            <!-- ++++ GROUP_FORM::START -->
            <form action="{{ url('task_system_integration/update') }}" method="POST" class="w-full max-w-lg">
                @csrf
                <div class="flex flex-col px-2 py-2">
                    ...
                    <div class="w-full md:w-1/1 px-3 py2">
                        ...
                        <div class="px-2 py-2 mb-2 border border-blue-400 rounted">{{$wip_task_system_integrations->task_sys_integ}}</div>
                    </div>
                    <!-- +++ COL::task_sys_name+++ -->
                    <div class="w-full md:w-1/1 px-3 py-2">
                        ...
                        <input name="task_sys_integ_name" value="{{$wip_task_system_integrations->task_sys_integ_name}}" class="appearance-none block w-full text-blue-900 border border-gray-600 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" placeholder="">
                    </div>
                </div> 
                <!-- +++ COL::BUTTON +++ -->
                ...
                <input type="hidden" name="task_sys_integ" value="{{$wip_task_system_integrations->task_sys_integ}}">
            </form>
            <!-- ++++ GROUP_FORM::EMD -->
        </div>
        <!-- ######## LEFT_AREA::END ########## -->
