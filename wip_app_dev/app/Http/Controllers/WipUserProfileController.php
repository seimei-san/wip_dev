...
class WipUserProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $wip_report_intervals = WipReportInterval::get();
        $wip_task_systems = WipTaskSystem::get();
        $wip_task_system_integrations = WipTaskSystemIntegration::get();
        ...
        ->with('wip_report_intervals', $wip_report_intervals)
        ->with('wip_task_systems', $wip_task_systems)
        ->with('wip_task_system_integrations', $wip_task_system_integrations);
    }
    ...
    public function store(Request $request)
    {
        ...
        $wip_user_profile->employee_id = $request->employee_id;
        ...
        $wip_user_profile->report_interval = $request->report_interval;
        $wip_user_profile->task_sys = $request->task_sys;
        $wip_user_profile->task_sys_user_id = $request->task_sys_user_id;
        $wip_user_profile->task_sys_project = $request->task_sys_project;
        $wip_user_profile->task_sys_integ = $request->task_sys_integ;
