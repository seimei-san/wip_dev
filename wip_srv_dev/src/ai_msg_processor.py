...
##################################################
def ai_msg_parser(domain_id, user_id, chat_sys, display_name, chat_user_id, conversation_id, thread_id, message_id, date, time, msg_ai, msg_org, mentioned_user_id):
